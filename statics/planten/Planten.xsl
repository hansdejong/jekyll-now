...
<br />
  ...
  <font color="red">TODO</font> / bugs:<ul>
    ...
    Dat bleek goed te gaan, maar toch had ik het idee dat de connectie met de gegevens later soms verdween.<br/>De oorzaak van mijn wantrouwen lijkt nu voort te komen uit het gebruik van verschillende browsers. Die zien elkaars gegevens niet bij weergave van de site.</b></li>
    <li>Voor de zekerheid zou je de pagina kunnen opslaan. Dan wordt het een lokale html-file.</li>
