...
<br />
  ...
  <font color="red">TODO</font> / bugs:<ul>
    ...
    Dat bleek goed te gaan, maar toch had ik het idee dat de connectie met de gegevens later soms verdween.<br/>De oorzaak van mijn wantrouwen lijkt nu voort te komen uit het gebruik van verschillende browsers. Die zien elkaars gegevens niet bij weergave van de site.<br/>
Voor de zekerheid zou je <!--, als de gegevens belangrijk voor je zijn, voorlopig--> de pagina kunnen opslaan. Dan wordt het een lokale html-file.
</b></li>
  </ul>
